...
function CardImage({
  ...
  return (
    <div className="relative w-full h-80 shrink-0 rounded-t-[1.25rem] overflow-hidden">
      <div
...
export const AfiliadoCard = ({ afiliado, forceRepMode = false, variant = 'default', highlighted = false }: AfiliadoCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-between p-4 pt-5 pb-5">
        ...
        {((isCorpView ? (afiliado.empresa_email || afiliado.email) : afiliado.email) || afiliado.instagram || afiliado.linkedin || afiliado.facebook || afiliado.twitter || afiliado.tiktok || afiliado.website || (isCorpView && afiliado.empresa_website)) && (
          <div className="flex gap-2 items-center justify-center pt-1 border-t border-slate-100 dark:border-emerald-50/10 w-full mt-auto">
