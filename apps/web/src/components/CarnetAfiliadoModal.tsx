...
export default function CarnetAfiliadoModal({ isOpen, onClose, afiliado, onUpdateAfiliado }: CarnetAfiliadoModalProps) {
  ...
  const handleEditClick = (e: React.MouseEvent) => {
    ...
    const activePhoto = (useJuntaPhoto && afiliado?.foto_junta_url) ? afiliado.foto_junta_url : afiliado?.foto_url;
  ...
  const handleCropSave = async () => {
    ...
    try {
      ...
      // parseRedes: asegura que redes_sociales sea un objeto aunque venga como string del backend
